...
describe("useGifs", () => {
  //Evalua que se carguen las propiedades y metodos (gifs y previousTerms con valor inicial de 0).
  ...
  //Evalua que devuelva una lista de 10 elementos al hacer una busqueda
  ...
  //Evalua que devuelva una lista de 10 elementos cuando handleTermClicked es llamado
